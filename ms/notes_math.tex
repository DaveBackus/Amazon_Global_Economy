...
\input{\blurbpath Blurbs/blurbs_math}
\rule{\textwidth}{1pt}
...
Each data series has a name (e.g., GDPC1 for US real GDP). As an exercise, find and graph the consumer price index \index{price index!consumer price index (CPI)}
