...
\input{\blurbpath Blurbs/blurbs_bop}
\rule{\textwidth}{1pt}
...
At the end of 2012, the US had a net financial asset position of
...
on the rest of the world by this amount.  A complete accounting
 of assets and liabilities is reported in Table~\ref{tab:usniip}.\index{current account}
