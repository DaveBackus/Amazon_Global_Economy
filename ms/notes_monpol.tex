...
\input{\blurbpath Blurbs/blurbs_monpol}
\rule{\textwidth}{1pt}
...
and a helpful indicator of how bond \index{bond} markets respond to announcements
...
The Fed has used {\it   forward guidence\/} \index{monetary policy!policy duration commitment} \index{monetary policy!forward guidance}
...
increases in inflation\index{inflation} and output.
