...
\input{\blurbpath Blurbs/blurbs_cycles}
\rule{\textwidth}{1pt}
...
to 8 percent (in 1966 and 1984).\index{gross domestic product (GDP)!real GDP|(}
...
\begin{figure}[ht]
 \caption{Level and fluctuations of US \href{http://research.stlouisfed.org/fred2/series/GDPC1?cid=106}{real GDP}.}
    \label{fig:yandgy}
    \centering
    \includegraphics[width=0.8\textwidth]{\figpath Figures/us_gdp.pdf}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \label{fig:gcall}%
    \centering
    \includegraphics[width=0.8\textwidth]{\figpath Figures/us_inv_cons_gdp.pdf}
\end{figure}
...
\caption{Fluctuations in employment and GDP.}
    \label{fig:labor}%
    \centering
    \includegraphics[width=0.8\textwidth]{\figpath Figures/us_emp_gdp.pdf}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \label{fig:stock}%
    \centering
    \includegraphics[width=0.8\textwidth]{\figpath Figures/us_gdp_sp500.pdf}
\end{figure}
