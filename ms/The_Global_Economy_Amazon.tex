...
\include{notes_inflation}
\include{notes_asad}
\include{notes_asadpolicy}
\include{notes_monpol}

% Other topics
\include{notes_review_other}
\include{notes_taxes}
\include{notes_deficits}
\include{notes_bop}
\include{notes_fx}
\include{notes_fxregimes}
\include{notes_crises}
